const API = {
  ...
  async getTrackingByHabit(habitId, startDate, endDate) {
    ...
    let url = `/tracking/habit/${habitId}?date=${today}`;
  ...
  async getOverview() {
    const today = this.getLocalDateString();
    return this.request(`/analytics/overview?date=${today}`);
  },

  async getWeeklyData() {
    const today = this.getLocalDateString();
    return this.request(`/analytics/weekly?date=${today}`);
  },

  async getMonthlyData() {
    const today = this.getLocalDateString();
    return this.request(`/analytics/monthly?date=${today}`);
  },
